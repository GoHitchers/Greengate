      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <div className="w-12 h-px bg-[#A78F51] mb-10" />

            <div className="space-y-7">
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Phone size={16} className="text-[#A78F51]" />
                </div>
                <div>
                  <p className="font-sans text-[10px] tracking-widest uppercase text-white/50 mb-1">Phone</p>
                  <a href="tel:0792758821" className="font-sans text-white text-sm hover:text-[#A78F51] transition-colors">
                    079 275 8821
                  </a>
                  <span className="text-white/40 mx-2 text-xs">/</span>
                  <a href="tel:0115271978" className="font-sans text-white text-sm hover:text-[#A78F51] transition-colors">
                    011 527 1978
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Mail size={16} className="text-[#A78F51]" />
                </div>
                <div>
                  ...
                  <a
                    ...
                    className="font-sans text-white text-sm hover:text-[#A78F51] transition-colors break-all"
                  >
              ...
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Globe size={16} className="text-[#A78F51]" />
                </div>
                <div>
              ...
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 bg-white/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <MapPin size={16} className="text-[#A78F51]" />
                </div>
                <div>
          ...
          <div>
            {sent ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-16">
                <div className="w-16 h-16 bg-[#A78F51] flex items-center justify-center mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/8 border border-white/20 text-white placeholder-white/30 px-4 py-3 font-sans text-sm focus:outline-none focus:border-[#A78F51] transition-colors duration-200"
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-[#A78F51] text-white font-sans text-xs tracking-widest uppercase hover:bg-[#8f7840] transition-colors duration-300 flex items-center justify-center gap-3"
                >
